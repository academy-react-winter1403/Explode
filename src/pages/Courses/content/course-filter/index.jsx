...
const CourseFilter = ({
    ...
    return (
        <div className={`w-[298px] mt-[60px] border-[2px] border-[#DCDCDC] rounded-[32px] p-[15px] max-[1050px]:w-[100%]  ${responsiveFilter ? "max-[600px]:fixed" : "max-[600px]:hidden"}  max-[600px]:z-1000 max-[600px]:w-[100%] max-[600px]:top-0 max-[600px]:right-0 max-[600px]:bg-[#fff] max-[600px]:mt-0`}>
