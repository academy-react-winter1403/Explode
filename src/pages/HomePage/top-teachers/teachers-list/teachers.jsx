...
const Teachers = () => {
    return (
        <Fragment>
            <div className="w-[170px] h-[180px] flex flex-col items-center justify-evenly relative top-[40px] max-[750px]:order-2 max-[750px]:top-[10px] max-[750px]:right-[20px]">
            ...
            <div className="w-[170px] h-[180px] flex flex-col items-center justify-evenly relative  top-[40px]  max-[750px]:order-3 max-[750px]:top-[50px]">
